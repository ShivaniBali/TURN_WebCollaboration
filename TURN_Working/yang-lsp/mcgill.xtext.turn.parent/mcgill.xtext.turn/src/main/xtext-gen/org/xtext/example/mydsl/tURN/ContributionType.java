 ...
 * <!-- end-user-doc -->
 * @see org.xtext.example.mydsl.tURN.TURNPackage#getContributionType()
 * @model
 * @generated
 */
public enum ContributionType implements Enumerator
{
   ...
   * @ordered
   */
  SOME_POSITIVE(3, "somePositive", "somePositive"),
   ...
   * @ordered
   */
  SOME_NEGATIVE(5, "someNegative", "someNegative"),
   ...
   * @ordered
   */
  public static final int SOME_POSITIVE_VALUE = 3;
   ...
   * @ordered
   */
  public static final int SOME_NEGATIVE_VALUE = 5;
