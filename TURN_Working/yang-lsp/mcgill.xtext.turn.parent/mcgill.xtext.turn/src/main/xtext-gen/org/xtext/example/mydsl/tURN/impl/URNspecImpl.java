 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.tURN.impl.URNspecImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.tURN.impl.URNspecImpl#getInfo <em>Info</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.tURN.impl.URNspecImpl#getStratGroups <em>Strat Groups</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.tURN.impl.URNspecImpl#getStrategies <em>Strategies</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.tURN.impl.URNspecImpl#getIndConversions <em>Ind Conversions</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.tURN.impl.URNspecImpl#getContribContextGroups <em>Contrib Context Groups</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.tURN.impl.URNspecImpl#getContribContexts <em>Contrib Contexts</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.tURN.impl.URNspecImpl#isShowAsMeansEnd <em>Show As Means End</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.tURN.impl.URNspecImpl#getUcmMaps <em>Ucm Maps</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.tURN.impl.URNspecImpl#getActors <em>Actors</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.tURN.impl.URNspecImpl#getConcerns <em>Concerns</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.tURN.impl.URNspecImpl#getUrnlinks <em>Urnlinks</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.tURN.impl.URNspecImpl#getMetadata <em>Metadata</em>}</li>
 * </ul>
 *
 * @generated
 */
