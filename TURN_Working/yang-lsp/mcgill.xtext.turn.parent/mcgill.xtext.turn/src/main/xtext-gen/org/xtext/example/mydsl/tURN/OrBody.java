 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.tURN.OrBody#getElseBody <em>Else Body</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.tURN.OrBody#getRegularBody <em>Regular Body</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.mydsl.tURN.TURNPackage#getOrBody()
 * @model
 * @generated
 */
public interface OrBody extends EObject
{
   ...
   * @see org.xtext.example.mydsl.tURN.TURNPackage#getOrBody_ElseBody()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.tURN.OrBody#getElseBody <em>Else Body</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link org.xtext.example.mydsl.tURN.RegularOrFork}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.xtext.example.mydsl.tURN.TURNPackage#getOrBody_RegularBody()
   * @model containment="true"
   * @generated
   */
