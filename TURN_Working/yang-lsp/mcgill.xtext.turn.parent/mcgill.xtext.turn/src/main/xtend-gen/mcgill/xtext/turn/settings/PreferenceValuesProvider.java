...
import mcgill.xtext.turn.settings.JsonFileBasedPreferenceValues;
...
public class PreferenceValuesProvider implements IPreferenceValuesProvider {
  ...
  private static final Map<String, String> constantSettings = CollectionLiterals.<String, String>newHashMap();
